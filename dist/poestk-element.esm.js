import React, { useRef, useState, forwardRef, createElement, useEffect } from 'react';
...
const BaseButton$1 = props => {
  ...
  const downRef = useRef(false); // Focus events
  ...
  return React.createElement(_default$3.BaseButton, _default({
...
const BaseInput$1 = props => {
  ...
  const [isFocused, setIsFocus] = useState(false);
  if (disabled && isFocused) setIsFocus(false);
  return React.createElement(_default$4.BaseInput, _default({
    "aria-invalid": true,
    "aria-describedby": '',
    className: className,
    disabled: disabled,
...
const BaseElement = styled.div.withConfig({
...
const BaseMotionWrapper = styled.div.withConfig({
...
const BaseMotionElement = styled(motion.div).withConfig({
...
const EMPTY_OBJECT = {};
const BaseElement$1 = forwardRef((props, ref) => {
  const {
    animation,
    children,
    className,
  ...
  for (const key in props.style) {
    if (props.style[key] instanceof MotionValue) {
  ...
  if (!animation) {
    return React.createElement(_default$6.BaseElement, _default({
      // @ts-ignore
      ref: ref,
      as: tag,
      propFill: fill,
  ...
  return React.createElement(_default$6.BaseMotionWrapper, _default({
    ref: ref,
    as: tag,
    className: className,
    propWidth: width || size || undefined,
    ...
    style: EMPTY_OBJECT,
    "data-testid": "baseElement"
  }), React.createElement(_default$6.BaseMotionElement, _default({
    propFill: fill,
    center: center,
    cursor: undefined,
    propDirection: direction,
...
const Button = styled(BaseButton$1).withConfig({
...
const Button$1 = (_ref) => {
  ...
  return React.createElement(_default$7.Button, rest, children);
};
...
const Element$1 = styled(BaseElement$1).withConfig({
  displayName: "style__Element",
  componentId: "sc-1qaay3n-0"
})([""]);
const Reset = styled.div.withConfig({
...
const Element$2 = forwardRef((_ref, ref) => {
  let {
    children
  } = _ref,
      rest = _default$2(_ref, ["children"]);

  return React.createElement(_default$8.Element, _default({
    ref: ref
  }, rest), children);
});
...
const Reset$1 = ({
  ...
  return React.createElement(_default$8.Reset, null, children);
};

const Scroll = ({
  children
}) => {
  return React.createElement(Element$2.reset, null, React.createElement(_default$8.Scrollable, null, children));
};
...
const Main$1 = (_ref) => {
  ...
  return React.createElement(_default$9.Main, _default({
    direction: direction
  }, rest), children);
};
...
const Scrollable$1 = styled.div.withConfig({
...
const TextFieldStyle = styled.div.withConfig({
...
const InputStyle = styled(BaseInput$1).withConfig({
...
function TextField(_ref) {
  ...
  const hash = shortid();
  return React.createElement(_default$a.TextFieldStyle, {
    fixedWidth: fixedWidth
  }, React.createElement(_default$a.InputWrapper, null, React.createElement(_default$a.InputStyle, _default({
    placeholder: placeholder && example,
    type: type || 'text',
    required: required,
    id: hash,
    readOnly: readOnly || disabled
  }, props)), placeholder && React.createElement(_default$a.Label, {
    htmlFor: hash
  }, React.createElement("p", null, required && '*', placeholder))), helperText && React.createElement(_default$a.HelperText, null, helperText));
}
...
const Wrapper = styled(BaseElement$1).withConfig({
...
const Container = styled.div.withConfig({
  ...
  blocksUserInput
}) => blocksUserInput && css(["&:after{content:'';top:0;right:0;bottom:0;left:0;z-index:999;}"]));
const Item = styled(BaseButton$1).withConfig({
...
const ItemGroup = styled.div.withConfig({
  displayName: "style__ItemGroup",
  componentId: "sc-155p8ed-3"
})([""]);
const ItemIcon = styled.div.withConfig({
...
const Item$1 = ({
  ...
  return React.createElement(_default$b.Item, {
    onClick: action,
  ...
  }, React.createElement(_default$b.ItemGroup, null, description), React.createElement(_default$b.ItemGroup, null, shortcut));
};
...
const Selection = ({
  ...
  const itemList = actions.flatMap((group, index) => {
    const jsxGroup = group.map(item => {
      itemIndex++;
      return React.createElement(Item$1, _default({
    ...
    if (index !== actions.length - 1) {
      jsxGroup.push(React.createElement(_default$b.Separator, {
  ...
  return React.createElement(_default$b.Wrapper, {
    animation: {
      drag: true,
      dragMomentum: false,
      initial: {
  ...
  }, React.createElement(_default$b.Container, {
    blocksUserInput: true,
    onMouseLeave: () => setCurrentSelectedIndex(-1)
  }, React.createElement("div", null, itemList)));
};
...
export { BaseButton$1 as BaseButton, BaseElement$1 as BaseElement, BaseInput$1 as BaseInput, Button$1 as Button, Element$2 as Element, GlobalStyle, Main$1 as Main, Scrollable$1 as Scrollable, Selection, TextField, useForm, useKeyPress, useOutsideClick };
